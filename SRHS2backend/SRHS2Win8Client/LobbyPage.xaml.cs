 ...
 * */
        ...
        private async void DiscoverSpheros()
        {
            try
            {
                ...
                if (spheroInformations != null && spheroInformations.Count > 0)
                {
                    ...
                    DiscoveredSpheros.ItemsSource = spheroInformations;
                }
                else
                {
                    // No sphero Paired
        ...
        {
            if (DiscoveredSpheros.SelectedItem != null)
            {
                SpheroConnection connection = await SpheroConnectionProvider.CreateConnection((SpheroInformation)DiscoveredSpheros.SelectedItem);
                ...
                else
                {
                   //App.CurrentConnection = connection;
                    chatDialog.Text += "\r\n" + "Success! "+ DiscoveredSpheros.SelectedItem +" is now connected";
                }
        ...
        */
        ...
        private void FindSpheros_Button_clicked(object sender, RoutedEventArgs e)
        {
            //DiscoverSpheros();
        }
