...
namespace SRHS2Win8Client
{
    ...
    public sealed partial class GameSettingsPage : Page
    {
        ...
        public User tu12 = new User("tu1ID", "tu1");
        public User tu22 = new User("tu2ID", "tu2");
        public User tu32 = new User("tu3ID", "tu3");
        public User tu42 = new User("tu4ID", "tu4");
        /// <summary>
        ...
        private void CreateGame_Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                case 0:
                    Debug.WriteLine("Need to select Player Type");
                    break;
                case 1:
                    ugame.SpheroPlayer = App.Current.AppUser;
                    ugame.DronePlayer = opponent;
                    break;
                case 2:
                    ugame.DronePlayer = App.Current.AppUser;
                    ugame.SpheroPlayer = opponent;
                    break;
                default:
                    break;
            }
