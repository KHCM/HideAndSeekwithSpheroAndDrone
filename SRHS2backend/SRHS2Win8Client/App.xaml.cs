...
namespace SRHS2Win8Client
{
    ...
    sealed partial class App : Application
    {
        ...
        public List<User> OppUsers { get; set; }
        public User OppUserTest { get; set; }
        ...
        //public static SpheroConnection CurrentConnection { get; set; }

        public static PushNotificationChannel CurrentChannel { get; private set; }

        private async Task<PushNotificationChannel> AcquirePushChannel()
        {
