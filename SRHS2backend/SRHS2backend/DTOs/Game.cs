...
namespace SRHS2backend
{
    ...
    public class Game
    {
        ...
        public Game(string gid, User testSpheroP1, User testDroneP2, int state, int status, int time, int hit, string opn, string crtn, string dronePlayerName, string spheroPlayerName)
        {
            ...
            this.DronePlayerName = dronePlayerName;
            this.SpheroPlayerName = spheroPlayerName; 
